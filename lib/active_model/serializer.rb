...
module ActiveModel
  class Serializer
    ...
    def serializable_hash(adapter_options = nil, options = {}, adapter_instance = self.class.serialization_adapter_instance)
      puts "\n\ActiveModelSerializers::Serializer:166 REQUEST...#{DateTime.now.strftime('%Q')}\n\n"
      adapter_options ||= {}
      puts "\n\ActiveModelSerializers::Serializer:168 REQUEST...#{DateTime.now.strftime('%Q')}\n\n"
      options[:include_directive] ||= ActiveModel::Serializer.include_directive_from_options(adapter_options)
      puts "\n\ActiveModelSerializers::Serializer:170 REQUEST...#{DateTime.now.strftime('%Q')}\n\n"
      cached_attributes = adapter_options[:cached_attributes] ||= {}
      puts "\n\ActiveModelSerializers::Serializer:172 REQUEST...#{DateTime.now.strftime('%Q')}\n\n"
